...
- In Oracle RDBMS, a System Identifier (`SID`) is a unique name that identifies a particular database instance. The SIDs are an essential part of the connection process, as it identifies the specific instance of the database the client wants to connect to.
...
- `odat` now is bult-in wiht linux.

- `./odat.py all -s 10.129.204.235`  or `odat all -s 10.129.204.235`
