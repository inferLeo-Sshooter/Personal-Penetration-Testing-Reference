...
**Notice:**
> When using APIs to interact with a database, POST is used to create a resource, PUT is used to update all fields of the specified resource, PATCH updates some fields of the specified resource.
