...
- [1. GraphQL API Vulnerabilities](#1-graphql-api-vulnerabilities)
  ...
  - [1.6 - Components of queries and mutations](#16---components-of-queries-and-mutations)
    - [Fields](#fields)
    - [Arguments](#arguments)
    - [Variables](#variables)
    - [Aliases](#aliases)
    - [Fragments](#fragments)
  - [1.7 - Example Exploitation with Mutations](#17---Example-Exploitation-with-Mutations)
  - [1.8 - Subscriptions](#18---subscriptions)
  - [1.9 - Introspection](#19---introspection)
- [2. Finding GraphQL endpoints](#2-finding-graphql-endpoints)
  - [2.1 - Universal queries](#21---universal-queries)
  - [2.2 - Common endpoint names](#22---common-endpoint-names)
  - [2.3 - Request methods](#23---request-methods)
...
- [4. Discovering schema information](#4-discovering-schema-information)
  - [4.1 - Using introspection](#41---using-introspection)
  - [4.2 - Probing for introspection](#42---probing-for-introspection)
  - [4.3 - Running a full introspection query](#43---running-a-full-introspection-query)
  - [4.4 - Visualizing introspection results](#44---visualizing-introspection-results)
  - [4.5 - Suggestions](#45---suggestions)
- [5. Tools of trade](#5-Tools-of-trade)
  - [5.1 - graphw00f](#51---graphw00f)
  - [5.2 - GraphQL-Voyager](#52---GraphQL-Voyager)
  - [5.3 - GraphQL-Cop](#53---GraphQL-Cop)
  - [5.4 - InQL](#54---InQL)
