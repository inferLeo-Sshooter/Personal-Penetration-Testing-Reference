...
- [osTicket](#osticket)
  - [1. Footprinting/Discovery/Enumeration](#1-footprintingdiscoveryenumeration)
  - [2. Attacking osTicket](#2-attacking-osticket)
  - [3. osTicket - Sensitive Data Exposure](#3-osticket---sensitive-data-exposure)
- [GitLab](#gitlab)
  - [1. Footprinting & Discovery](#1-footprinting--discovery)
  - [2. Enumeration](#2-enumeration)
- [Attacking GitLab](#attacking-gitlab)
  - [1. Username Enumeration](#1-username-enumeration)
  - [2. Authenticated Remote Code Execution](#2-authenticated-remote-code-execution)
...
- Automated scripts (Bash/Python) or use this [script](https://www.exploit-db.com/exploits/49821) for efficiency
- The Python3 version of this same tool can be found [here](https://github.com/dpgg101/GitLabUserEnum).
